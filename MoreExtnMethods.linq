...
/*
	Assignment 6
	Enter your name here: Esther Bier (Shapiro)
	60 Points
*/
...
void Main()
{
	...
	*/
	...
	{
    var financialAidCount = group.Count(s => s.FinancialAid);
    var noFinancialAidCount = group.Count(s => !s.FinancialAid);
    Console.WriteLine("Year " + group.Key + " has " + financialAidCount + " students on financial aid, and " 
                      + noFinancialAidCount + " students not on financial aid.");
	}
	Console.WriteLine();
	...
	/* Question 2
	   ...
	   ********************************
		...
		Jenny Latoon	  
	*/
	var studentsbygradecount = students.GroupBy(student => student.Grades.Length);
	foreach(var sgroup in studentsbygradecount)
	{
		Console.WriteLine("Students with " + sgroup.Key + " grades:");
		foreach(var student in sgroup)
	...
	/* Question 3a
	   ...
	   ********************************	   
		...
		Students with 3.06833333333333 gpa:
			Sam Mitchel
	*/
	var studentsbygpa = students.GroupBy(student => student.Grades.Average());
	...
	/* Question 3b
	   ...
	   ********************************
		...
		Students with 2 gpa:
			...
			Jenny Latoon	   
	*/
	var studentsbyroundedgpa = students.GroupBy(student => Math.Round(student.Grades.Average()));
	...
	/* Question 4
	   ...
	   ********************************
		...
		Sam Mitchel
	*/
	students.Where(student => student.Grades.Average() > 3.0)
	...
	*/ 
	...
	Console.WriteLine("The avearge of all grades for all students is: " + allgrades.Average());
	Console.WriteLine();
	...
	*/
	students.SelectMany(student => student.Grades)
					.OrderBy(grade => grade)
					.Select(grade => Math.Round(grade))
            .ToList()
            .ForEach(grade => Console.Write(grade + " "));
